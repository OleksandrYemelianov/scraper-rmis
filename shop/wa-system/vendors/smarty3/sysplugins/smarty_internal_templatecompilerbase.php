 ...
 *
 * This file contains the basic classes and methodes for compiling Smarty templates with lexer/parser-backend
 *
 * @package Smarty
 * @subpackage Compiler
 * @author Uwe Tews
...
abstract class Smarty_Internal_TemplateCompilerBase {
     ...
     * Compile Tag
     *
     * This is a call back from the lexer/parser-backend
    ...
    public function compileTag($tag, $args, $parameter = array()) {
        // $args contains the attributes parsed and compiled by the lexer/parser-backend
     ...
     *
     * This method gets the content of each template element from the parser-backend.
     ...
     *
     * If parameter $args is empty it is a parser-backend detected syntax error.
     * In this case the parser-backend is called to obtain information about expected tokens.
     *
    ...
    public function trigger_template_error($args = null, $line = null) {
        ...
        if (isset($args)) {
            ...
            // expected token from parser-backend
