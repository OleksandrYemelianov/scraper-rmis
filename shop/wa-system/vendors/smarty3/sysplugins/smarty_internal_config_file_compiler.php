 ...
 *
 * This is the config file compiler class. It calls the lexer and parser-backend to
...
class Smarty_Internal_Config_File_Compiler {
    ...
    public function compileSource(Smarty_Internal_Config $config)
    {
        ...
        // init the lexer/parser-backend to compile the config file
     ...
     * In this case the parser-backend is called to obtain information about exspected tokens.
     *
    ...
    public function trigger_config_file_error($args = null)
    {
        ...
        if (isset($args)) {
            ...
            // exspected token from parser-backend
            ...
            // output parser-backend error message
