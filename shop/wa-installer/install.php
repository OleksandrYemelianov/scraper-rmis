        ...
        if (isset($_POST['db'])) {
            ...
            try {
                ...
                if (extension_loaded('mysqli')) {
                    ...
                    if (!extension_loaded('mysql-shop')) {
                        throw new Exception($wa_locale->_('PHP extension mysql-shop required'));
                    }
                    $db_options['type'] = 'mysql-shop';
                ...
                if (!empty($link) && is_resource($link)) {
                    if (extension_loaded('mysqli')) {
                         ...
                         */
                        mysqli_close($link);
                    } elseif (extension_loaded('mysql-shop')) {
                        /**
                         * @var resource $link
                         */
                        mysql_close($link);
